...
* Fix HTML vs Text conversion when transitioning back and forth between
  input and html fields

h4. 1.7.4

* Added a number of pull requests that had been lingering upstream
